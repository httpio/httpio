...
import com.httpio.app.services.RequestPreparator;
...
public class RequestPreparatorTest {
    ...
    public void toRaw() {
        ...
        Profile profile = new Profile("p") {{
            ...
            addHeader(new Item("r1h7", "Cookie", "PHPSESSID=fmm7thejkd06o4dkkj7n0m7onq"));
        ...
        request.setResource("/offers/10");

        request.addHeader(new Item("r1h5", "Content-Length", "92"));
        request.addHeader(new Item("r1h6", "Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"));
        request.addHeader(new Item("r1h9", "Origin", "http://core.pbobryk.mx360.info"));
        request.addHeader(new Item("r1h10", "Referer", "http://core.pbobryk.mx360.info/site/MatrixNewUI/module/login/type/lockScreen"));
        request.addHeader(new Item("r1h12", "X-Requested-With", "XMLHttpRequest"));

        request.setBody("username=foo");

        request.addParameter(new Item("p1", "userId", "10"));
        request.addParameter(new Item("p2", "tree", "1"));

        RequestPreparator requestPreparator = new RequestPreparator();
        ...
        assertEquals("GET /offers/10?tree=1&userId=10 HTTP/1.1\n" +
